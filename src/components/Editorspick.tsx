import slider from "../../public/slide1.jpg"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <div
          ...
          <div className="p-6 bg-white">
            ...
            <p className="text-gray-600 text-sm mt-2">5 types of Hoodi available</p>
        ...
        <div
          ...
          <div className="p-6 bg-white">
            ...
            <p className="text-gray-600 text-sm mt-2">5 types of hoodies available</p>
        ...
        <div
          ...
          <div className="p-6 bg-white">
            ...
            <h4 className="text-lg text-gray-800 font-bold mt-2">$14.5</h4>
            <p className="text-gray-600 text-sm mt-2">5 types of Accessories available</p>
